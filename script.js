...
submitButton1.onclick = () => {
  ...
  else if(numberInput1 <20){
    message1 = 'That was a terrible score!';
  }
  else if( numberInput1<40){
...
submitButton2.onclick = () => {
  ...
  switch (true){
   case (numberInput2>=100 || numberInput2<=0):
  message2 = "This is not possible. An error has occured.";
  break;
  case (numberInput2>=0 || numberInput2<=19):
  message2 = "That was a terrible score!";
  break;
  case (numberInput2>=20 || numberInput2<=39):
  message2 = "You know somethings. Needs improvement.";
  break;
  case (numberInput2>=40 || numberInput2<=69):
  message2 = "You did passable job,not bad!";
  break;
